...
RenderState RenderState_construct()
{
    return (RenderState){.bDebugHitboxes = false, .VSync = false, .renderIsometric = true,
                         ...
                         .isoTileAtlas = loadAtlas("isoatlas.png", 4, 4), .isoCharacterAtlas = loadAtlas("isocharacter.png", 2, 8), .uiItemAtlas = loadTexture("isoItems.png"), .isoItemAtlas = loadAtlas("isoItems.png", 4, 4),
...
{
    refreshRoom(gState, rState, true);
